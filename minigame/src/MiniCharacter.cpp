...
MiniCharacter::MiniCharacter(float x, float y, const std::string& leftTex, const std::string& rightTex)
...
unsigned int MiniCharacter::loadTexture(const std::string& path) {
    int w, h, ch;
...
GLuint MiniCharacter::getShader() const {
    return characterShader;
}

void MiniCharacter::initRenderer() {
    float vertices[] = {
...
void MiniCharacter::handleInput(GLFWwindow* window) {
    vx = 0.f;
...
void MiniCharacter::update(float dt, int windowHeight, int windowWidth, const std::vector<Platform>& platforms) {
...
float MiniCharacter::getX() const {
    return x;
}

float MiniCharacter::getY() const {
    return y;
}

float MiniCharacter::getWidth() const {
    return width * 1.0f / 4.0f;
}

float MiniCharacter::getHeight() const {
