...
ClientGame::ClientGame()
{
    ...
    bool ret = client_logic::LoadTextureFromFile("C:/Users/azhsu/Desktop/group3/external/images/HeistAtTheMuseumTitle.png", &my_image_texture, &my_image_width, &my_image_height);
